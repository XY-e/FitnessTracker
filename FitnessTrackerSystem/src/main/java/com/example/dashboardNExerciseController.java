...
//public class dashboardNExerciseController extends Application {
public class dashboardNExerciseController {
        private final ObservableList<Exercise> exerciseLogData = FXCollections.observableArrayList();
        ...
        public Scene createScene(Stage primaryStage) {
                ...
                profileButton
                                .setGraphic(new ImageView(new Image(
                                                getClass().getResource("/images/profile.png").toExternalForm())));
                ...
                moreMenu.setGraphic(
                                new ImageView(new Image(
                                                getClass().getResource("/images/moreoption.png").toExternalForm())));
                ...
                myProgressButton.setOnAction(e -> System.out.println("Navigated to My Progress View."));
